                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        //c.SingleApiVersion("v1", "Sample API - Dimensions CRUD");
                        ...
                        c.MultipleApiVersions(
                            (apiDesc, targetApiVersion) => SelectTargetApi(apiDesc, targetApiVersion),
                            (vc) =>
                            {
                                vc.Version("v2", "Sample API V 2.0");
                                vc.Version("v1", "Sample API V 1.0");
                            });
                        ...
                        c.IncludeXmlComments($@"{System.AppDomain.CurrentDomain.BaseDirectory}bin\SampleAPI.XML");
                        ...
                        // Operation filters.
                        //
                        c.OperationFilter<Filters.HeaderKeyParameterOperationFilter>();
                        //
                        ...
                        // Added an Examples operation filter
